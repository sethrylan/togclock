...
- (void)viewDidLoad
{
    ...
    self.aboutText.text = @"Togclock is an application developed as part of an HCI project for CSC554. Togclock uses basic email and password authentication to a Toggl (toggl.com) account. It will retain your account information until you click 'logout'. If you do not have a Toggl account, you can use user1@sethrylan.org with the password 'secret'.";
}
